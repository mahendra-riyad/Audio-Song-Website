<%-- 
    Document   : main-song-play
    Created on : Jul 16, 2019, 3:52:44 PM
    Author     : MAHENDRA
--%>
<%@ page import="java.sql.*" %>
        ...
        %> 
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="mediumModalLabel" style="font-weight: 200; letter-spacing: 4px; word-spacing: 8px;">Song Details</h5>
