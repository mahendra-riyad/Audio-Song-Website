...
public final class new_005fsong_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                             <form method=\"post\" action=\"song_insert.jsp\">\n");
      ...
      out.write("                                                <select name=\"album_name\"  style=\"font-size: 14px; width: 60%; letter-spacing: 2px; word-spacing: 4px; padding:15px; border:1px solid #cccccc; opacity: .8\">\n");
      out.write("                                                    <option value=\"No album\">No Album</option>\n");
      out.write("                                                    ");
      ...
      out.write("                                                     $(\"select.category_select\").change(function(){\n");
      out.write("                                                       var category = $(this).children(\"option:selected\").val();\n");
      out.write("                                                       var song=$(\"input#song_name\").val();\n");
      out.write("                                                       if(song==''){\n");
      out.write("                                                          alert(\"enter name\");  \n");
      out.write("                                                       }\n");
      out.write("                                                       else{\n");
      out.write("                                                          \n");
      out.write("                                                            $.post(\"song_category.jsp\",{song_name:song,category:category},function(data){\n");
      out.write("                                                                $(\"#category_selected\").html(data);\n");
      out.write("                                                            });\n");
      out.write("                                                            \n");
      out.write("                                                       }\n");
      out.write("                                                        \n");
      ...
      out.write("\t\t\t\t\t\t<div class=\"modal-header\">\n");
      out.write("\t\t\t\t\t\t\t<h5 class=\"modal-title\" id=\"smallmodalLabel\">Photo Insert</h5>\n");
      out.write("\t\t\t\t\t\t\t<button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\">\n");
      out.write("\t\t\t\t\t\t\t\t<span aria-hidden=\"true\">&times;</span>\n");
      ...
      out.write("                                            All songs\t</b><button type=\"button\" class=\"btn btn-primary mb-1\" data-toggle=\"modal\" data-target=\"#mediumModal\" style=\"float:right\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tNew Songs\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</button></div>\n");
