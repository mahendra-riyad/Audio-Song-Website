<%-- 
    Document   : song_photo
    Created on : Jun 23, 2019, 2:25:05 AM
    Author     : MAHENDRA
--%>
...
{         
   ...
   try{
                                                    ...
                                                    Statement st = cn.createStatement();
                                                     st.execute("update song set photo_status="+status+" where song_code='"+random+"'");
...
FileOutputStream fileOut = new FileOutputStream(request.getRealPath("/")+"/song-photo/"+saveFile);
